// ============================================================================
// Environment fingerprint / summary / detail rendering. Returns HTML strings
// consumed by the comparison detail page (env header) and the detail panel
// (per-suite env detail).
// ============================================================================
